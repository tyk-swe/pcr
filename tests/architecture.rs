...
const SAFETY_SENSITIVE_PROTOCOL_CONSUMERS: &[&str] = &[
    ...
    "src/protocol/matcher/echo.rs",
    "src/protocol/matcher/mod.rs",
    "src/protocol/matcher/quoted_icmp.rs",
    "src/protocol/matcher/reverse_flow.rs",
    "src/protocol/matcher/sctp.rs",
