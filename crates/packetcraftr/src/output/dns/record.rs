...
impl From<packetcraftr_workflow::dns::Section> for DnsSection {
    fn from(value: packetcraftr_workflow::dns::Section) -> Self {
        match value {
            packetcraftr_workflow::dns::Section::Answer => Self::Answer,
            packetcraftr_workflow::dns::Section::Authority => Self::Authority,
            packetcraftr_workflow::dns::Section::Additional => Self::Additional,
        }
    }
}
