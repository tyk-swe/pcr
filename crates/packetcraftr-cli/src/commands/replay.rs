...
use packetcraftr_capture::{Format, Limits, Reader, ReaderOptions, Writer};
use packetcraftr_net as net;
use packetcraftr_output as output;
use packetcraftr_workflow as workflow;
use packetcraftr_workflow_client as workflow_client;
...
pub(crate) fn run_replay(
    ...
    let mut transmitter = workflow_client::replay::SystemTransmitter::new();
...
fn execute_replay<F>(
    ...
    transmitter: &mut workflow_client::replay::SystemTransmitter,
