...
//! Native passive route and interface-route provider.
...
/// Concise aliases inside the route namespace.
pub use self::{NativeRouteError as SystemError, SystemRouteProvider as SystemProvider};
...
mod tests {
    ...
    #[test]
    fn native_route_errors_classify_their_remediation_family() {
        assert_eq!(
