...
- [ ] The scan and traceroute engines contain only workflow-specific classification and evidence shapes. Their copied process-batch, classify, retain, undecoded-retention and diagnostic-publishing routines are gone.
...
- [ ] The scan and traceroute tests that both checked event collection preserving stats, diagnostics and evidence limits become one runner test.
- [ ] Scan, traceroute and probe contract tests pass.
