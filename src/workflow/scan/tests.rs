...
mod tests {
    ...
    use crate::net::{
        ...
        InterfaceId, IoSendReport, LinkCapability, LinkMode, LiveIoError, NeighborResolver,
        PacketIo, PlanOptions, RouteDecision, RouteProvider, RouteSelectionReason,
        TransmissionFrame,
    };
    ...
    fn client_dns_executor_waits_for_capture_and_always_shuts_it_down() {
        use crate::workflow::dns::{
            encode_query as encode_dns_query, Exchange as DnsExchange, Executor as DnsExecutor,
            Probe as DnsProbe, QueryType as DnsQueryType,
        };
