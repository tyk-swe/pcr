...
/// ```text
/// use std::io::Cursor;
/// use crate::pcap::{Reader, ReaderOptions, Writer};
/// use packetcraftr_packet::frame::LinkType;
///
/// # fn example() -> Result<(), crate::pcap::Error> {
...
///
/// ```text
/// use crate::pcap::{Endianness, PcapOptions, Writer};
/// use packetcraftr_packet::frame::LinkType;
///
/// # fn example() -> Result<(), crate::pcap::Error> {
...
///
/// ```text
/// use crate::pcap::{PcapNgOptions, Writer};
/// use packetcraftr_packet::frame::LinkType;
///
/// # fn example() -> Result<(), crate::pcap::Error> {
