...
use super::super::envelope::{DiagnosticOutput, OperationStats, OutputError};
...
impl From<packetcraftr_workflow::fuzz::Mode> for FuzzMode {
...
impl From<packetcraftr_workflow::fuzz::CaseOutcome> for FuzzCaseOutcome {
...
impl From<packetcraftr_workflow::fuzz::Strategy> for FuzzStrategy {
...
impl From<packetcraftr_workflow::fuzz::Mutation> for FuzzMutation {
...
impl From<packetcraftr_workflow::fuzz::Reproduction> for FuzzReproduction {
