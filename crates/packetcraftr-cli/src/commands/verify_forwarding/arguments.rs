...
Examples:
  ...
  packetcraftr verify-forwarding pre.pcap post.pcap --identity udp.payload --ingress-filter 'udp.destination_port == 9000'
...
pub(crate) struct Args {
    ...
    /// Field that must compare equal on a uniquely matched pair; repeatable.
