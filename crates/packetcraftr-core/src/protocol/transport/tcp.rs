...
reflective_layer! {
    ...
    impl Tcp {
        "source_port" | "sport" => { kind: Unsigned, tier: Required, description: "TCP source port",
            reflect: source_port, layout: (0, 2) },
        "destination_port" | "dport" => { kind: Unsigned, tier: Required, description: "TCP destination port",
            reflect: destination_port, layout: (2, 4) },
        "sequence" => { kind: Unsigned, tier: Required, description: "Sequence number",
            reflect: sequence, layout: (4, 8) },
        "acknowledgment" => { kind: Unsigned, tier: Optional, default: "0", description: "Acknowledgment number",
            reflect: acknowledgment, layout: (8, 12) },
        "reserved_bits" => { kind: Unsigned, tier: Optional, default: "0", description: "Three reserved TCP header bits",
            reflect_bounded: reserved_bits, 7_u64, layout: (12, 13) },
        "flags" => { kind: Unsigned, tier: Required, description: "Nine TCP control flags",
            reflect_bounded: flags, 0x01ff_u64, layout: (12, 14) },
        "window" => { kind: Unsigned, tier: Required, description: "Receive window",
            reflect: window, layout: (14, 16) },
        "checksum" => { kind: Unsigned, tier: Derived, description: "TCP checksum",
            wire: checksum, layout: (16, 18) },
        "urgent_pointer" => { kind: Unsigned, tier: Optional, default: "0", description: "Urgent pointer",
            reflect: urgent_pointer, layout: (18, 20) },
        "options" => { kind: Bytes, tier: Optional, default: "0x", description: "Verbatim standard or unknown TCP options",
