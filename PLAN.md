...
- Wave 3 complete: full integrated formatting, Clippy, all-feature workspace tests/doctests, warning-denied API docs and final debt audit passed. Numeric DNS fuzz completed 68,896 executions in 31 seconds without a crash. [CI run 34261005592](https://github.com/tyk-swe/pcr/actions/runs/34261005592) passed all five jobs and native v3 archive checks.
...
- Final release coverage: CI builds and verifies optimized all-features and exact pcap-free archives on Linux, macOS ARM/Intel and Windows. Both local optimized Linux archives passed shared verification, libpcap linkage/isolation, and clean Ubuntu 24.04 runtime smokes. The archive-profile follow-up passed independent review and the negative linkage failure fixture.
- Delivery is tracked in [PR #158](https://github.com/tyk-swe/pcr/pull/158), including final native checks and applicable CODEOWNERS review.
