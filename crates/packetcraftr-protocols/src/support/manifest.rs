...
pub const BUILTIN_CAPTURE_ROOTS: &[CaptureRootSupport] = &[
    capture_root(
        packetcraftr_model::LinkType::NULL.0,
        BuiltinProtocol::BsdNull,
        CaptureRootByteOrder::CapturedHost,
    ),
    capture_root(
        packetcraftr_model::LinkType::ETHERNET.0,
        BuiltinProtocol::Ethernet,
        CaptureRootByteOrder::ProtocolDefined,
    ),
    capture_root(
        packetcraftr_model::LinkType::BSD_RAW.0,
        BuiltinProtocol::RawIp,
        CaptureRootByteOrder::ProtocolDefined,
    ),
    capture_root(
        packetcraftr_model::LinkType::RAW.0,
        BuiltinProtocol::RawIp,
        CaptureRootByteOrder::ProtocolDefined,
    ),
    capture_root(
        packetcraftr_model::LinkType::LOOP.0,
        BuiltinProtocol::BsdLoop,
        CaptureRootByteOrder::Network,
    ),
    capture_root(
        packetcraftr_model::LinkType::LINUX_SLL.0,
        BuiltinProtocol::LinuxSll,
        CaptureRootByteOrder::Network,
    ),
    capture_root(
        packetcraftr_model::LinkType::IPV4.0,
        BuiltinProtocol::Ipv4,
        CaptureRootByteOrder::ProtocolDefined,
    ),
    capture_root(
        packetcraftr_model::LinkType::IPV6.0,
        BuiltinProtocol::Ipv6,
        CaptureRootByteOrder::ProtocolDefined,
    ),
    capture_root(
        packetcraftr_model::LinkType::LINUX_SLL2.0,
