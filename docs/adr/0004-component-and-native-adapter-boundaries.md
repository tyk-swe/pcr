...
- Route/interface and Layer 2 adapters share dedicated private Linux, macOS, and Windows modules; later platform tickets extend those same ownership boundaries with L3 and additional exchange implementation.
