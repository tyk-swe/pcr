...
pub mod dns {
    pub use super::dns_impl::{
        ...
        DnsAttemptEvidence as AttemptEvidence, DnsAttemptStatus as AttemptStatus,
        DnsError as Error, DnsExchange as Exchange, DnsExchangeExecution as Execution,
        DnsExecutionError as ExecutionError, DnsExecutor as Executor, DnsLimits as Limits,
        DnsMatchedResponse as MatchedResponse, DnsOutcome as Outcome, DnsProbe as Probe,
        DnsQueryType as QueryType, DnsRecord as Record, DnsRecordValue as RecordValue,
        DnsRejectedRecord as RejectedRecord, DnsRequest as Request,
        DnsResponseClassification as ResponseClassification, DnsResult as Result,
        DnsSection as Section, DnsTransport as Transport,
