...
where
    R: packetcraftr_network::route::Provider,
    N: packetcraftr_network::neighbor::Resolver,
    I: packetcraftr_network::transmit::Sender + packetcraftr_network::capture::Provider,
{
