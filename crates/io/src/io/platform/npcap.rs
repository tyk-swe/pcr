...
use crate::io::{CaptureQueueLimits, InterfaceId, IoSendReport, Layer2Frame, LiveIoError};
...
mod supported {
    ...
    use crate::io::{
        CaptureQueueLimits, InterfaceId, IoSendReport, Layer2Frame, LinkType, LiveIoError,
    };
