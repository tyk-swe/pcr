...
pub use self::{Address as InterfaceAddress, Flags as InterfaceFlags};
pub use self::{Info as InterfaceInfo, Provider as InterfaceProvider};
...
pub struct Info {
    ...
    pub link_type: packetcraftr_model::LinkType,
}
