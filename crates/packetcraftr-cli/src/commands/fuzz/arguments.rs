...
impl From<CliFuzzStrategy> for packet::fuzz::Strategy {
...
pub(crate) struct FuzzArgs {
    ...
    #[arg(long, default_value_t = packet::fuzz::DEFAULT_CASES)]
    ...
    #[arg(long, default_value_t = packet::fuzz::DEFAULT_MAX_CASES)]
    ...
    #[arg(long, default_value_t = packet::fuzz::DEFAULT_MAX_FIELD_BYTES)]
    pub(crate) max_field_bytes: usize,
    /// Maximum list elements generated by one mutation.
    #[arg(long, default_value_t = packet::fuzz::DEFAULT_MAX_LIST_ITEMS)]
    pub(crate) max_list_items: usize,
    /// Maximum deterministic shrink candidates returned per case.
    #[arg(long, default_value_t = packet::fuzz::DEFAULT_MAX_SHRINK_STEPS)]
