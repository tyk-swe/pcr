...
impl<R: RouteProvider> RouteProvider for ExchangeRouteProvider<'_, R> {
    ...
    fn classify_error(&self, error: &Self::Error) -> packetcraftr_packet::error::Classification {
...
mod tests {
    ...
    use super::*;
    use packetcraftr_network::link::{Capability, MacAddress};
    use packetcraftr_network::route::{Scope, SelectionReason};
