...
//! CLI runtime setup, command dispatch, environment configuration, and platform client initialization.
...
pub(crate) use startup::run_entrypoint;

pub(crate) use system::{SystemClient, default_registry_arc, system_client};
