...
pub(super) type PcapGetInteger = unsafe extern "C" fn(*mut c_void) -> c_int;
pub(super) type PcapListTstampTypes = unsafe extern "C" fn(*mut c_void, *mut *mut c_int) -> c_int;
pub(super) type PcapFreeTstampTypes = unsafe extern "C" fn(*mut c_int);
pub(super) type PcapTstampTypeToStr = unsafe extern "C" fn(c_int) -> *const c_char;
