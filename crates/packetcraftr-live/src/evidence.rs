...
#[cfg(test)]
pub(crate) fn test_sent_packet(packet: packetcraftr_packet::Packet) -> SentPacket {
...
pub(crate) fn test_sent_packet_with_report(
    packet: packetcraftr_packet::Packet,
    report: TransmissionReport,
) -> SentPacket {
...
#[cfg(test)]
fn test_built_packet(packet: packetcraftr_packet::Packet) -> BuiltPacket {
    use std::sync::Arc;

    use packetcraftr_packet::build::{Builder, Context, Options};
