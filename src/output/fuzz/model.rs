...
use crate::packet::{diagnostic::Diagnostic, document::PacketDocument};
...
pub struct FuzzMutation {
    ...
    pub original: crate::packet::field::FieldValue,
    pub value: crate::packet::field::FieldValue,
}
...
pub struct FuzzCaseOutput {
    ...
    pub shrink_values: Vec<crate::packet::field::FieldValue>,
