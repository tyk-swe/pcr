...
#[cfg(feature = "native-route")]
use crate::io::{
    InterfaceAddress, InterfaceFlags, InterfaceId, InterfaceInfo, LinkCapability, LinkType,
    MacAddress, NativeRouteError, RouteDecision, RouteSelectionReason,
};
...
mod tests {
    ...
    fn native_linux_provider_finds_loopback_routes_and_interfaces() {
        ...
        let provider = crate::io::SystemRouteProvider;
        let ipv4 = provider
