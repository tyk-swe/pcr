...
use packetcraftr_net::{
    ...
    route::{InterfaceId, RouteDecision, RouteSelectionReason},
};
...
mod tests {
    use super::*;
    use packetcraftr_net::route::Provider as RouteProvider;
    ...
    fn native_linux_provider_finds_loopback_routes_and_interfaces() {
        ...
        let provider = crate::route::SystemRouteProvider;
        let ipv4 = provider
    ...
    fn repeated_lookups_reuse_the_calling_threads_netlink_worker() {
        ...
        crate::route::SystemRouteProvider
            .lookup_with_preferences(IpAddr::V4(Ipv4Addr::LOCALHOST), None, None)
            .unwrap();
