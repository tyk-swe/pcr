...
//!
//! Every engine here is driven through injected executor, authorizer, and
//! clock traits, so replay, scan, traceroute, DNS, and fuzz stay deterministic
//! and testable without an active network stack. Concrete client-backed
//! executors and native transmitters live in `packetcraftr-workflow-client`.
...
pub use stats::Stats;
pub use target_adapter::PolicyAuthorizer;
