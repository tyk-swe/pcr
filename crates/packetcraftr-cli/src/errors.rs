...
impl CliError {
    ...
    pub(super) fn into_boundary_error(self) -> packetcraftr_workflow::BoundaryError {
        packetcraftr_workflow::BoundaryError::new(self.message, self.classification, self.causes)
    }
