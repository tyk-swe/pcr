...
use packetcraftr_model::error::{Category, Classification, Classified, Kind};
...
/// Classifies a destination address into its routing scope. Native route
/// adapters use it to describe the decision they returned.
pub fn classify_destination(address: IpAddr) -> DestinationScope {
