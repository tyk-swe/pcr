...
//! Compilation and application of declared forwarding rules.
...
use super::observation::retained_bytes;
use super::{
    CheckKind, Error, ExpectationOutcome, Incomplete, Observation, Side, SideInput, ValueState,
};
...
///
/// Rules are the complete contract [`verify`](super::verify) evaluates: identity fields
...
pub struct Rules {
    identity: Projection,
    pub(super) preserve: Vec<Projection>,
...
impl Expectation {
    pub(super) fn kind(&self) -> CheckKind {
