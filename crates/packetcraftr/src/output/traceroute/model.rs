...
impl From<packetcraftr_workflow::traceroute::ProbeStatus> for TraceProbeStatus {
...
impl From<packetcraftr_workflow::traceroute::ResponseKind> for TraceResponseKind {
...
impl From<packetcraftr_workflow::traceroute::Completion> for TraceCompletionReason {
